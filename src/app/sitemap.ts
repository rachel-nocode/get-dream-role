...
const staticRoutes = [
  ...
  { path: "/ats/brassring", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/ats/workable", priority: 0.8, changeFrequency: "monthly" as const },
  { path: "/ats/smartrecruiters", priority: 0.8, changeFrequency: "monthly" as const },
